...
public class Tile extends PApplet {
  ...
  public Tile(ArrayList<Integer> colorArray, int matrixSize, int squareSize,
      String name) {
  ...
  public void draw() {
    ...
    setPreferredSize(new Dimension(matrixSize * squareSize, matrixSize
        * squareSize));
  }
  ...
  void drawSquare(int i, int j, int squareColor, int squareSize) {
    try {
      ...
      System.out
          .println("caught index out of bounds on prototile (ok if you just sized down)");
    }
  }
